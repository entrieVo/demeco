...
export function bayesianDenoise<T extends Float32Array[] | Uint8ClampedArray>(
	signal: T,
	...
	if (
		...
		return audioBayesianFilter(signal, relativeNoiseLevel) as unknown as T;
...
export function imageBayesianFilter(
